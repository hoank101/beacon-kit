...
func TestBytes8MarshalJSON(t *testing.T) {
	tests := []struct {
		name  string
		input bytes.B8
		want  string
		...
		{
			name:  "all zeros",
			input: bytes.B8{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
			want:  `"0x0000000000000000"`,
		},
		{
			name:  "all ones",
			input: bytes.B8{0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF},
			want:  `"0xffffffffffffffff"`,
		},
		{
			name:  "mixed bytes",
			input: bytes.B8{0xAA, 0xBB, 0xCC, 0xDD, 0xEE, 0xFF, 0x11, 0x22},
